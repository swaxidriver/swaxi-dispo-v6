        ...
        <div className="flex h-16 justify-between">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              {auth?.user && <ActiveRoleBadge className="ml-4" />}
              {!auth?.user && (
                <NavLink
                  to="/login"
                  className={({ isActive }) =>
  ...
  try {
    ...
    return (
      <div className="flex items-center">
        <button
          onClick={fb.open}
          className="ml-4 text-sm text-gray-300 hover:text-white border border-transparent hover:border-gray-300 rounded px-3 py-1"
