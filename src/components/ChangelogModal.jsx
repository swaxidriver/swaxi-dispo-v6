...
const CHANGELOG_DATA = [
  {
    ...
    description:
      "Modernized font to Manrope, added design tokens with persistent theme, visible role badges, and enhanced test scaffolding.",
  },
  {
    version: "0.2.0",
    date: "2025-08-26",
    ...
    description:
      "Added offline action queue with automatic replay, accessibility improvements including focus management, and optimistic shift operations.",
  },
  {
    version: "0.1.0-test",
    date: "2025-08-26",
    ...
    description:
      "Initial shift assignment workflow, notification center, week calendar view, shift templates, and role-based authentication.",
  },
];
