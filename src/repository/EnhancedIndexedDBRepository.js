...
export class EnhancedIndexedDBRepository extends ShiftRepository {
  ...
  async updateShiftTemplate(id, updates) {
    ...
    // Log the template update with before/after states
    AuditService.logCurrentUserActionWithStates(
      "Template updated",
      beforeState,
      updated,
      null,
    ...
    try {
      ...
      AuditService.logCurrentUserAction(
        "Assignment created",
        {
          ...
          shiftInstanceId: entity.shift_instance_id,
          disponentId: entity.disponent_id,
  ...
  async updateAssignment(id, updates) {
    ...
    // Log the assignment update with before/after states
    AuditService.logCurrentUserActionWithStates(
      "Assignment updated",
      beforeState,
      updated,
  ...
  async hardDeleteAssignment(id) {
    // Get the assignment before deleting for audit logging
    ...
    if (assignment) {
      AuditService.logCurrentUserAction(
        "Assignment deleted",
        {
          ...
          disponentId: assignment.disponent_id,
