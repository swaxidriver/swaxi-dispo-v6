  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="truncate flex-1">{shift.type || shift.name}</span>
...
export function TimelineShiftCell({
  ...
  // Map legacy English test shift types to German display for consistency
  const displayType = (shift.type || shift.name || "")
    .replace("Morning", "Früh")
    .replace("Afternoon", "Spät");
  return (
    <div
    ...
    >
      <div className="font-semibold truncate">{displayType}</div>
