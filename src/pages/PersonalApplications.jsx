  ...
  if (!user) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-6">{t("personalApplications")}</h1>
        <p className="text-gray-600">{t("pleaseLoginToSeeApplications")}</p>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          {t("personalApplications")}
        </h1>
        <p className="text-gray-600">{t("personalApplicationsDescription")}</p>
      </div>
      ...
      {userApplications.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-gray-500 mb-4">{t("noApplicationsText")}</p>
          <a
            href="/calendar"
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            {t("showAvailableShifts")}
          </a>
        </div>
      ) : (
