          ...
          <div className="space-y-4">
            <label className="flex items-center">
              ...
              <span className="text-sm font-medium text-text">
                E-Mail Benachrichtigungen für Dienst-Zuweisungen aktivieren
              </span>
            </label>
            ...
            <div className="ml-6 space-y-2">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  checked={settings.immediateRemovalNotice !== false}
                  onChange={(e) =>
                    updateSetting("immediateRemovalNotice", e.target.checked)
                  }
                  disabled={settings.emailNotifications === false}
                  className="mr-3 text-[var(--color-primary)] focus:ring-[var(--color-primary)] disabled:opacity-50"
                />
                <span className="text-sm text-text">
                  Sofortige Benachrichtigung bei Entfernung von Zuweisungen
                </span>
              </label>

              <div className="flex items-center space-x-3">
                <span className="text-sm text-text">
                  Tägliche Übersicht um:
                </span>
                <input
                  type="time"
                  value={settings.digestTime || "18:30"}
                  onChange={(e) => updateSetting("digestTime", e.target.value)}
                  disabled={settings.emailNotifications === false}
                  className="rounded-md border-border py-1 px-2 text-sm focus:border-[var(--color-primary)] focus:outline-none focus:ring-[var(--color-primary)] disabled:opacity-50"
                />
              </div>
            </div>
            ...
            <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-md">
              <p className="text-sm text-blue-800">
                <strong>Hinweis:</strong> E-Mail Benachrichtigungen werden für
                Dienst-Zuweisungen und -Entfernungen versendet. Die tägliche
                Übersicht fasst alle Änderungen des Tages zusammen.
              </p>
            </div>
          </div>
        </div>
