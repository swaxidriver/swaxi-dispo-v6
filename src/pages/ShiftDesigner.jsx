    ...
    <div className="container mx-auto p-4" data-testid="shift-designer">
      ...
      <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-sm text-blue-700 space-y-1">
          <p>
            <strong>Templates Tab:</strong> Create, edit, clone, and delete
            shift templates. Each template defines a shift pattern with specific
            times, days, and colors.
          </p>
          <p>
            <strong>Generator Tab:</strong> Select templates and generate shifts
            for multiple weeks. Preview the changes before applying them.
          </p>
          <p>
            All actions are logged in the audit system for tracking and
            compliance.
          </p>
        </div>
      </div>
