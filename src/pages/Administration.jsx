  ...
  const handleClearAllData = () => {
    ...
    if (confirmed) {
      try {
        ...
        alert(
          "Alle Daten wurden erfolgreich gelöscht. Die Seite wird neu geladen.",
        );
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mt-8 border border-blue-200 rounded-lg p-6 bg-blue-50">
        ...
        <p className="text-blue-700 mb-4">
          Import people and shift templates from CSV files, or export
          assignments for Perdis/WebComm systems.
        </p>
        ...
        <div className="space-y-4">
          ...
          {!repository && (
            <p className="text-sm text-gray-500 mt-2">
              Repository not available. Please wait for the system to
              initialize.
            </p>
          )}
        </div>
          ...
          {showDangerZone && (
            <div className="mt-4 p-4 border border-red-300 rounded bg-white">
              ...
              <p className="text-sm text-red-600 mb-4">
                Diese Aktion löscht alle Schichten, Audit-Logs, Snapshots und
                andere Anwendungsdaten unwiderruflich.
              </p>
