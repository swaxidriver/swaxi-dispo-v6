...
describe('ShiftDesigner', () => {
  test('renders with default templates tab', () => {
    ...
    expect(screen.getByText('Create and manage shift templates, then generate shifts for multiple weeks.')).toBeInTheDocument()
  ...
  test('shows help section', () => {
    ...
    expect(screen.getByText('💡 How to use the Shift Designer')).toBeInTheDocument()
