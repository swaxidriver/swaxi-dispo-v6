...
describe("Route Guards", () => {
  ...
  describe("RoleCheck", () => {
    ...
    test("renders fallback for non-matching role", () => {
      renderWithAuth(
        <RoleCheck allowedRoles={ROLES.ADMIN} fallback={<div>Not Admin</div>}>
          <div>Admin Panel</div>
        </RoleCheck>,
        mockUser(ROLES.ANALYST),
        "/protected",
  ...
  describe("Hooks", () => {
    ...
    describe("useUserCapabilities", () => {
      const TestComponent = () => {
        ...
        return (
          <div>
            <div data-testid="manage-shifts">
              {capabilities.canManageShifts.toString()}
            </div>
            <div data-testid="view-audit">
              {capabilities.canViewAudit.toString()}
            </div>
            <div data-testid="apply-shifts">
              {capabilities.canApplyForShifts.toString()}
            </div>
            <div data-testid="view-analytics">
              {capabilities.canViewAnalytics.toString()}
            </div>
            <div data-testid="assign-shifts">
              {capabilities.canAssignShifts.toString()}
            </div>
            <div data-testid="manage-templates">
              {capabilities.canManageTemplates.toString()}
            </div>
          </div>
        );
      };
      ...
      test("returns correct capabilities for admin", () => {
        ...
        expect(screen.getByTestId("manage-templates")).toHaveTextContent(
          "true",
        );
      });
