...
describe('LiveVersionBanner', () => {
  ...
  test('shows update banner when version differs', () => {
    ...
    expect(screen.getByText(/Neue Version verfügbar – neu laden/)).toBeInTheDocument()
  ...
  test('can dismiss update banner', () => {
    ...
    const dismissButton = screen.getByRole('button', { name: 'Update-Benachrichtigung ausblenden' })
    fireEvent.click(dismissButton)
    
    // Update banner should be hidden
    expect(screen.queryByText(/Neue Version verfügbar – neu laden/)).not.toBeInTheDocument()
  })
})
