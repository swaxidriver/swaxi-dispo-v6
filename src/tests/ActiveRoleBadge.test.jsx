...
describe("ActiveRoleBadge", () => {
  ...
  it("shows admin only nav items and hides for analyst", () => {
    ...
    renderWithProviders(analystNav, {
      authUser: { id: "x", name: "Analyst", role: ROLES.ANALYST },
    });
