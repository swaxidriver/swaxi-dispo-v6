...
const { generateShifts } = jest.requireMock('../services/shiftGenerationService')

const mockTemplates = [
  { id: '1', name: 'Morning', startTime: '08:00', endTime: '12:00', days: ['Mo','Tu'], color: '#3B82F6' },
  { id: '2', name: 'Evening', startTime: '18:00', endTime: '22:00', days: ['Fr','Sa'], color: '#EF4444' }
]
...
function setup() {
  ...
  generateShifts.mockReturnValue([
    { id: 'shift-1', name: 'Morning', date: '2025-01-06', start: '08:00', end: '12:00' }
  ])
...
describe('ShiftWeeklyGenerator', () => {
  ...
  test('can select templates and generate preview', () => {
    ...
    // Generate preview
    const generateBtn = screen.getByRole('button', { name: 'Generate Preview' })
  ...
  test('shows message when no templates available', () => {
    ...
    expect(screen.getByText('No templates available. Create templates first.')).toBeInTheDocument()
  })
})