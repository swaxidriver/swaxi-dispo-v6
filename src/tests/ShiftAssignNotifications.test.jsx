...
describe('Shift assignment & notifications', () => {
  ...
  it('assigns a shift and updates status', async () => {
    ...
    const shift = { id: '2025-08-25_evening', date: new Date('2025-08-25'), start: '18:00', end: '20:00', status: 'open', type: 'evening', assignedTo: null, workLocation: 'office', conflicts: [] }
