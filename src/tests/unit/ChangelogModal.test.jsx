...
describe("ChangelogModal", () => {
  ...
  it("renders correctly when open", () => {
    ...
    expect(
      screen.getByText(/Aktuelle Änderungen und Verbesserungen/),
    ).toBeInTheDocument();
  });
  ...
  it("has correct accessibility attributes", () => {
    ...
    expect(
      screen.getByRole("heading", { name: "Änderungsprotokoll" }),
    ).toHaveAttribute("id", "changelog-title");
    expect(
      screen.getByText(/Aktuelle Änderungen und Verbesserungen/),
    ).toHaveAttribute("id", "changelog-desc");
  });
  ...
  it("displays changelog entries with version, date, title and description", () => {
    ...
    expect(
      screen.getByText("Design Tokens & Typography Update"),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByText("Offline Queue & Accessibility"),
    ).toBeInTheDocument();
  });
  ...
  it('closes when "Schließen" button is clicked', () => {
    ...
    const closeButtonText = closeButtons.find(
      (btn) => btn.textContent === "Schließen",
    );
  ...
  it("manages focus correctly", async () => {
    ...
    const { rerender } = render(
      <ChangelogModal isOpen={true} onClose={onClose} />,
    );
