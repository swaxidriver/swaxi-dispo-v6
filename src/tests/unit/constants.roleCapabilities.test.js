import { ROLES, canManageShifts, canAssignShifts, canManageTemplates, canViewAnalytics } from '../../utils/constants'
...
describe('role capability helpers', () => {
  ...
  it.each(roles)('canManageShifts(%s)', (r) => {
    const expected = r === ROLES.ADMIN || r === ROLES.CHIEF || r === ROLES.DISPONENT
  ...
  it.each(roles)('canViewAnalytics(%s)', (r) => {
    const expected = r === ROLES.ADMIN || r === ROLES.ANALYST || r === ROLES.CHIEF
