...
describe("RuleEngineService", () => {
  ...
  describe("checkAssignmentPermission", () => {
    test("should allow assignment with no violations", async () => {
      ...
      const result = await RuleEngineService.checkAssignmentPermission(
        { id: "test" },
        [],
        [],
      );
  ...
  describe("enforceAssignment", () => {
    test("should enforce assignment with user context", async () => {
      ...
      const result = await RuleEngineService.enforceAssignment(
        shift,
        [],
        [],
        options,
  ...
  describe("createOverrideDialogData", () => {
    test("should create override dialog data for UI", () => {
      ...
      const violations = [
        ...
        {
          ruleId: "NON_OVERRIDABLE",
          ruleName: "Non Overridable",
          description: "Test",
          severity: "BLOCKING",
          canOverride: false,
        },
      ...
      const result = RuleEngineService.createOverrideDialogData(
        shift,
        violations,
      );
