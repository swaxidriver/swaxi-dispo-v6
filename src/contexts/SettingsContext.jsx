...
export function SettingsProvider({ children }) {
  const [storedSettings, setStoredSettings] = useLocalStorage('swaxi.settings.preferences', initialState)
  const [state, dispatch] = useReducer(settingsReducer, storedSettings || initialState)
